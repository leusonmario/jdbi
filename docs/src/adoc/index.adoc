...
When a new configurable context is created, it inherits a copy of its
parent configuration at the time of creation - further modifications will
not affect already created configuration contexts.
...
it must have a no-args constructor that provides useful defaults and a *createCopy*
